...
func (b *Book) WriteID(newID int) {
	b.id = newID
}

func (b *Book) WriteTitle(newTitle string) {
	b.title = newTitle
}

func (b *Book) WriteAuthor(newAuthor string) {
	b.author = newAuthor
}

func (b *Book) WriteYear(newYear int) {
	b.year = newYear
}

func (b *Book) WriteSize(newSize int) {
	b.size = newSize
}

func (b *Book) WriteRate(newRate float64) {
	b.rate = newRate
}
