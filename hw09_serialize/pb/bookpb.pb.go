...
func (*BookList) Descriptor() ([]byte, []int) {
	return fileDescriptor_fbf59d96e76a6885, []int{1}
}
...
func (m *BookList) GetBooks() []*BookInfo {
	if m != nil {
		return m.Books
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BookList)(nil), "bookpb.BookList")
}
...
var fileDescriptor_fbf59d96e76a6885 = []byte{
	...
	0x51, 0x83, 0x29, 0x08, 0xcc, 0x56, 0x32, 0x82, 0xb8, 0xc2, 0x27, 0xb3, 0xb8, 0x44, 0x48, 0x8d,
	0x8b, 0x15, 0xe4, 0xb8, 0x62, 0x09, 0x46, 0x05, 0x66, 0x0d, 0x6e, 0x23, 0x01, 0x3d, 0xa8, 0xc3,
	0x61, 0xce, 0x0c, 0x82, 0x48, 0x27, 0xb1, 0x81, 0x7d, 0x62, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff,
	0x4a, 0x64, 0xe2, 0x14, 0xd9, 0x00, 0x00, 0x00,
}
